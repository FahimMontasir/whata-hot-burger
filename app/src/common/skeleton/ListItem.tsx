...
import {Loader, SkeletonLoader} from './index';
...
export const ListItemLoader = ({backgroundColor, highlightColor}: IProps) => {
  return (
    <SafeAreaView>
      <SkeletonLoader
...
const styles = StyleSheet.create({
  ...
  image: {height: 100, width: 100, marginRight: 10, borderRadius: 50},
